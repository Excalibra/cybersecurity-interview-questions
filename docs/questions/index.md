...
<select id="category-selector" style="width:100%; max-width:450px; padding:12px 16px; font-size:1.1em; background:#374151; color:white; border:1px solid #4b5563; border-radius:6px; margin-bottom:24px;">
