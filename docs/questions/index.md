...
<div style="display: flex; gap: 24px; align-items: flex-start;">
  ...
  <div id="dynamic-sidebar" style="width: 280px; background:#1f2937; padding:20px; border-radius:8px; border:1px solid #374151; min-height: 700px; min-width: 320px; flex-shrink: 0;">
